<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<section id="preferred" class="section-box">
		<div class="inner">
			<div class="box clearfix">
				...
				<div>
					...
					<ul class="nav nav-tabs" style="background-color:gray">
						<li class="active">
							<a href="#1" data-toggle="tab" style="color:white">type</a>
						</li>
						<li>
							<a href="#2" data-toggle="tab" style="color:white">source</a>
						</li>
					</ul>
				</div>
						...
						<div class="inner">
							<div class="box clearfix">
								<c:forEach var="feature" items="${em:features()}">
									<c:set var="descriptions" value="${em:preferredContent(taxon,feature)}"/>
										...
										<div class="inner">
											<div id="${feature}">
												...
												<c:forEach var="description" items="${descriptions}">
													<c:if test="${description.preferredDescription == true }">
							...
							<div class="inner">
								<div class="box clearfix">
									<c:forEach var="feature" items="${em:descriptionSources(taxon)}">
										<c:set var="descriptions" value="${em:preferredContentBySource(taxon,feature)}"/>
										<c:if test="${not empty descriptions}">
											<div class="inner">
												<div id="${feature}">
													<details>
